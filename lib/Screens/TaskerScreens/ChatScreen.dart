...
import 'package:MuqitTasker/Models/ChatMessageModel.dart';
import 'package:MuqitTasker/Models/ChatModel.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    print("Client ID :" + widget.clientid + "Tasker ID :" + widget.taskerid);
  }
  ...
  Future<Map<String, dynamic>> sendAndRetrieveMessage(
      String title, String body, String clientID) async {
    ...
    await http.post(
      ...
      body: jsonEncode(
        <String, dynamic>{
          'priority': 'high',
          'restricted_package_name': 'com.example.Muqit',
          'data': <String, dynamic>{
